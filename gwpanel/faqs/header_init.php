...
<script type="text/javascript">
	function getDeleteConfirmForm(faqid)
	{
		$.post('<?php echo get_admin_link(PAGE_FAQ_AJAX,tep_get_all_get_params(array('action','module','page'))); ?>',{action:'ajax', ajaxaction:'getDeleteForm',faqid:faqid}, function(data)
			{
