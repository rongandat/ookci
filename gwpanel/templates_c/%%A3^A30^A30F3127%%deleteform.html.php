<?php /* Smarty version 2.6.18, created on 2010-02-20 04:47:19
         compiled from faqs/deleteform.html */ ?>
<form name="frmdeleteconfirm" action="<?php echo $this->_tpl_vars['link_faqs']; ?>
" method="post">
	<input type="hidden"  name="action" value="deleteconfirm"  />
	<input type="hidden"  name="faqID" value="<?php echo $this->_tpl_vars['faqinfo']['faqs_id']; ?>
"  />	
	<table width="100%" cellpadding="2" cellspacing="2" border="0"  class="confirmContent">
		<tr><td class="maintext"><strong><?php echo $this->_tpl_vars['faqinfo']['faqs_name']; ?>
</strong></td></tr>
