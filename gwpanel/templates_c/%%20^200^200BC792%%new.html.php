<?php /* Smarty version 2.6.18, created on 2010-03-10 01:13:52
         compiled from faqs/new.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_radios', 'faqs/new.html', 14, false),array('function', 'dev_get_image_source', 'faqs/new.html', 23, false),)), $this); ?>
<h2><?php echo $this->_tpl_vars['langs']['HEADING_NEW_FAQ']; ?>
</h2>
<br />
...
unset($_smarty_tpl_vars);
 ?>
<div>
<form action="<?php echo $this->_tpl_vars['link_new_faq']; ?>
" method="post" name="frmNew" >
	<input type="hidden"  name="action" value="process" />
 	<table width="100%" cellpadding="2" cellspacing="2" >	
		<tr>
		  <td><?php echo $this->_tpl_vars['langs']['TEXT_FAQ_SORT_ORDER']; ?>
</td>
