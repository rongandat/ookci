<?php /* Smarty version 2.6.18, created on 2012-03-26 06:48:25
         compiled from admins/edit.html */ ?>
<h2><?php echo $this->_tpl_vars['langs']['HEADING_EDIT_ADMIN_ACCOUNT']; ?>
</h2>
<br />
...
*</td>
		  <td width="78%"><strong><?php echo $this->_tpl_vars['admin_username']; ?>
</strong><input name="admin_username" type="hidden" id="admin_username" value="<?php echo $this->_tpl_vars['admin_username']; ?>
" ></td>
	  </tr>
		<tr>
...
"  size="30"></td>
		...
		<tr>
		  <td><?php echo $this->_tpl_vars['LABEL_ADMIN_ACCOUNT_CURRENT_PASSWORD']; ?>
*</td>
		  <td><input name="current_password" type="text" id="current_password" value="<?php echo $this->_tpl_vars['current_password']; ?>
" size="30"></td>
	  </tr>	
