...
<script type="text/javascript">
	...
	{
		$.post('<?php echo get_admin_link(PAGE_EMAILTEMPLATE_AJAX,tep_get_all_get_params(array('action','module','page'))); ?>',{action:'ajax', ajaxaction:'getDeleteForm',emailtemplateid:emailtemplateid}, function(data)
			{
