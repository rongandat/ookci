...
">SCI Form/Button Generator</a>
            ...
            <li>
                <a href="<?php echo smarty_function_dev_get_page_link(array('page' => 'PAGE_QUICK_PAYMENT','ssl' => true), $this);?>
">Quick Payment</a>
            </li>
            <li>
...
" <?php if ($this->_tpl_vars['CURRENT_MODULE'] == 'account' && $this->_tpl_vars['CURRENT_PAGE'] == 'transfer'): ?> class="active" <?php endif; ?>>Transfer Money</a>
            ...
            <li>
                <a href="<?php echo smarty_function_dev_get_page_link(array('page' => 'PAGE_ACCOUNT_TRANSFER_WALLET','ssl' => true), $this);?>
" <?php if ($this->_tpl_vars['CURRENT_MODULE'] == 'account' && $this->_tpl_vars['CURRENT_PAGE'] == 'transfer_wallet'): ?> class="active" <?php endif; ?>>Transfer To Wallet</a>
            </li>
