<?php /* Smarty version 2.6.18, created on 2013-07-29 09:31:30
...
<table class="tablesorter" >
    <thead>
        <tr>
            <th class="tableHeading">Curency</th>
...
?>	
            <th class="tableHeading"><strong><?php echo $this->_tpl_vars['balances'][$this->_sections['balanceidx']['index']]['balance_code']; ?>
</strong></th>
            <?php endfor; endif; ?>
        </tr>
    </thead>
...
<table class="form">
    ...
    <tr>
        <td><a href="javascript: closeUserDetailsContent();" class="st-clear">Close</a></td>
    </tr>
</table>