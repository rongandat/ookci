<?php /* Smarty version 2.6.18, created on 2013-07-29 06:47:31
         compiled from emailtemplates/edit.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_radios', 'emailtemplates/edit.html', 21, false),array('function', 'dev_get_image_source', 'emailtemplates/edit.html', 31, false),)), $this); ?>
...
" border="0"/></a></li>
                    ...
                    <div style="border: 1px solid green; padding: 10px; width: 97%; margin-bottom: 1em;">
                        <?php unset($this->_sections['languageidx']);
$this->_sections['languageidx']['name'] = 'languageidx';
$this->_sections['languageidx']['loop'] = is_array($_loop=$this->_tpl_vars['languages']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['languageidx']['show'] = true;
...
" class="tabcontent">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="5">
                                <tr><td class="main" style="width: 120px;"><?php echo $this->_tpl_vars['langs']['TEXT_EMAILTEMPLATE_TITLE']; ?>
*</td>
...
" size="30"  /></td>
                                ...
                                <tr><td class="main"  ><?php echo $this->_tpl_vars['langs']['TEXT_EMAILTEMPLATE_SUBJECT']; ?>
*</td>
