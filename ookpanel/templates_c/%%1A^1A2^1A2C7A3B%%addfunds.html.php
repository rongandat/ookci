<?php /* Smarty version 2.6.18, created on 2013-07-29 09:46:11
         compiled from transactions/addfunds.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'dev_get_admin_page_link', 'transactions/addfunds.html', 15, false),array('function', 'html_options', 'transactions/addfunds.html', 92, false),)), $this); ?>
...
"  />
        ...
        <table class="form">	
            <tr><td colspan="2">Please make sure you want to <strong>add funds</strong> to account <strong><?php echo $this->_tpl_vars['transfer_info']['account_number']; ?>
        ...
        <table class="form">	
            ...
            <tr> 
                <td>&nbsp;</td>
                <td>
                    <input type="submit" name="btnTransfer" value="Transfer" class="st-button">
