<?php /* Smarty version 2.6.18, created on 2013-07-29 06:53:37
...
<div class="page-title" style="z-index: 780;">
    <div class="in" style="z-index: 770;">
        ...
        <div style="z-index: 810;" class="shortcuts-icons">
            <a original-title="Add Email Template" class="shortcut tips" href="<?php echo smarty_function_dev_get_admin_page_link(array('page' => 'PAGE_EMAILTEMPLATE_NEW'), $this);?>
...
" method="post" >
                    ...
                    <table class="tablesorter" >
                        <thead> 
                            <tr>
                                <th><?php echo $this->_tpl_vars['langs']['TABLE_HEADING_EMAILTEMPLATE_NAME']; ?>
</th>
                                <th><?php echo $this->_tpl_vars['langs']['TABLE_HREADING_EMAILTEMPLATE_STATUS']; ?>
</th>
