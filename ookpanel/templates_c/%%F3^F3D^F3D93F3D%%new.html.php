<?php /* Smarty version 2.6.18, created on 2013-07-29 06:45:00
         compiled from emailtemplates/new.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'dev_get_admin_page_link', 'emailtemplates/new.html', 12, false),array('function', 'html_radios', 'emailtemplates/new.html', 21, false),array('function', 'dev_get_image_source', 'emailtemplates/new.html', 30, false),)), $this); ?>
<div class="page-title" style="z-index: 780;">
    <div class="in" style="z-index: 770;">
        <div class="titlebar" style="z-index: 760;">	
            <h2><?php echo $this->_tpl_vars['langs']['HEADING_NEW_EMAILTEMPLATE']; ?>
</h2>	
        </div>
    </div>
...
unset($_smarty_tpl_vars);
 ?>
    <form action="<?php echo smarty_function_dev_get_admin_page_link(array('page' => 'PAGE_EMAILTEMPLATE_NEW'), $this);?>
" method="post" name="frmNew" >
        <input type="hidden"  name="action" value="process" />
        <table class="form" >	
            <tr>
                <td><?php echo $this->_tpl_vars['langs']['TEXT_EMAILTEMPLATE_KEY']; ?>
</td>
...
" class="tabcontent">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="5">
                                <tr>
                                    <td class="main"  width="120"><?php echo $this->_tpl_vars['langs']['TEXT_EMAILTEMPLATE_TITLE']; ?>
*</td>
...
]" id="wysiwyg" cols="100" rows="15" ><?php echo $this->_tpl_vars['emailtemplates_content'][$this->_tpl_vars['langid']]; ?>
</textarea></td>
                                </tr>
