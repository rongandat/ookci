...
<script type="text/javascript">
    ...
    {
        $.post('<?php echo get_href_link(PAGE_ACCOUNT_TRANSACTIONS_AJAX, tep_get_all_get_params(array('action', 'module', 'page')), 'SSL'); ?>',{doajax:'get_transaction_details',transaction_id:transactionid}, function(data)
        {
